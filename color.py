...
# ----------使用示例如下:-------------  
blue=color.Colored().blue
red=color.Colored().red
green=color.Colored().green
fuchsia=color.Colored().fuchsia
yellow=color.Colored().yellow
white=color.Colored().white
#color = Colored()  
